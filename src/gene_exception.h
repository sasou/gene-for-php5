...
#define HTML_ERROR_CONTENT "$e = Gene_Exception::getEx();echo ' [Uncaught ',get_class($e),']:',$e->getMessage(),' File:***',substr($e->getFile(),-(ceil(strlen($e->getFile())*0.6))),' ',$e->getLine();"
#define HTML_ERROR_CONTENT_NS "$e = \\Gene\\Exception::getEx();echo ' [Uncaught ',get_class($e),']:',$e->getMessage(),' File:***',substr($e->getFile(),-(ceil(strlen($e->getFile())*0.6))),' ',$e->getLine();"
